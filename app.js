...
router.use(expAutoSan.allUnsafe); //is used by the views to sanitize potentially dangerous values.
...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('Patchouli.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('Perfum.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('Patchouli.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.catalog.section[obj.sec_n].product.push({'item': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('Patchouli.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('Patchouli.xml', function(err, result) {
      ...
      delete result.catalog.section[obj.section].product[obj.product];
